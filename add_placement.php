...
<title>Добавяне на местоположение</title>
...
function Validate(){
    ...
    if(!(notEmpty(placement,"Въведете стринг!")))
        return false;
...
<div id="wrap">
	...
	<div id="content-outer" class="clear">
            <div id="content-wrap" >
                <h3>Добави местоположение</h3>
		<div class="content">
                    <form name="AddPlacementForm" method="post"
                          action="add_placement_validation.php" onsubmit="return Validate();">
			
			<p>
                                <label> местоположение: </label> <br>
                                <input name="placement" type="text" id="placement" size="30">
                        </p>
