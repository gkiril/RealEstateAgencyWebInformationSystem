...
<div id="wrap">
	...
	<div id="content-outer" class="clear">
            <div id="content-wrap" >
                <h3> Добави нов тип на жилище </h3>
		<div class="content">
			<form name="AddHouseTypeForm" method="post"
                          action="add_house_type_validation.php" onsubmit="return Validate();">

			<p>
                                <label> Тип на жилище: </label> <br>
                                <input name="HouseType" type="text" id="HouseType" size="30">
                        </p>
